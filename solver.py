...
def solve_schedule(inputs, max_spread_minutes=DEFAULT_MAX_START_SPREAD_MINUTES,
    ...
    for spread_minutes in steps:
        ...
        model, starts, group_lunch, assessor_lunch, _ = _build_model(
            inputs, groups, tools, assignments, horizon, max_spread_slots
        )
    ...
    raise ValueError(
        "No schedule fits this day. Try a longer day, fewer participants per "
        "assessor, or a shorter assessor-bound tool such as the BEI."
    )
