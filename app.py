...
st.markdown(
    """
<style>
:root { --accent:#38bdf8; --accent2:#818cf8; }
...
.hero {
    ...
    border: 1px solid rgba(56,189,248,.25); border-radius:18px; padding:20px 24px; margin-bottom:18px;
}
.hero h1 { margin:0; font-size:1.9rem; }
.hero p { margin:6px 0 0; color:#9fb3c8; }
.section {
    background:#111a2e; border:1px solid rgba(148,163,184,.14);
